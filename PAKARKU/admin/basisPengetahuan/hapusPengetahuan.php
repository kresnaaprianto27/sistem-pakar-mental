...
<head>
    ...
    <title>Konfirmasi hapus data pengetahuan</title>
    <style>
        body {
            overflow: hidden;
            margin: 0;
...
<body>
    <div class="container">
        <div class="kotakkonfirmasi">
            ...
            <h2>Apakah anda yakin ingin hapus data pengetahuan ?</h2>
    ...
    <?php if (isset($_POST['oke'])) { ?>
        <?php
        $query = "DELETE FROM tbl_pengetahuan WHERE idpengetahuan = '$idPengetahuan'";
