...
<head>
    ...
    <title>Konfirmasi hapus data gangguan</title>
    <style>
        body {
            overflow: hidden;
            margin: 0;
...
<body>
    <div class="container">
        <div class="kotakkonfirmasi">
            ...
            <h2>Apakah anda yakin ingin hapus data gangguan mental ?</h2>
    ...
    <?php if (isset($_POST['oke'])) { ?>
        <?php
        $query = "DELETE FROM tbl_gangguan WHERE idgangguan = '$idGangguan'";
